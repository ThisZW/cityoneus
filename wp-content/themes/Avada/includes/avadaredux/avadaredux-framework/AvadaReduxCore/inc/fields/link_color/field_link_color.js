...
(function( $ ) {
    ...
    avadaredux.field_objects.link_color = avadaredux.field_objects.link_color || {};
    ...
    avadaredux.field_objects.link_color.init = function( selector ) {

        if ( !selector ) {
            selector = $( document ).find( '.avadaredux-container-link_color:visible' );
        }
